...
&nbsp;&nbsp;</td>
      ...
      <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
          <tr align="center"> 
            <td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">商品名称</td>
<td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">保质期</td>
<td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">产地</td>
<td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">商品类别</td>
<td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">价格</td>
<td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">库存量</td>
<td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">折扣</td>
<td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">状态</td>
<td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">发布时间</td>
<td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">操作</td>
            </tr>
