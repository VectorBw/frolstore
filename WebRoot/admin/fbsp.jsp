...
<table width="95%" border="0" align="center"  cellpadding="0" cellspacing="0" >
  <tr>
    <td height="28" colspan="2" align="center"><strong>发布商品</strong></td>
  </tr>
  <tr>
    <td width="221" height="34" align="center">商品名称 </td>
...
<tr>
    <td width="221" height="34" align="center">商品类别 </td>
...
if(protypeobj.value==""){  
document.getElementById("clabelprotype").innerHTML="&nbsp;&nbsp;<font color=red>请输入商品类别</font>";  
return false;  
}else{
