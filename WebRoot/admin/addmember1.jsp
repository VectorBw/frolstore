...
if(suc!=null)
{
 ...
 <script language=javascript>
 alert("操作成功");
 parent.location.replace("/frolstore/admin/hygl.jsp");
 ...
 <%
  ...
  <form action="/frolstore/servlet/Addmember" name="f1" method="post" >
...
<script language="javascript" src="/frolstore/shop/popup.js"></script>
  <script language="javascript" src="/frolstore/shop/ajax.js"></script>
