 ...
 <%
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
          <tr align="center"> 
            <td height="18" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">类别名称</td>
            <td width="8%" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">删除</td>
             <td height="18" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">类别名称</td>
            <td width="8%" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">删除</td>
          </tr>
     ...
     ii++;
           ...
           <a href="/frolstore/admin/protype.jsp?did=<%=h.get("id") %>"> 删除</a>
