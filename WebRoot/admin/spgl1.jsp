 ...
 <%
  ...
  %>
   ...
   new CommDAO().commOper("delete from yqlj where id="+did);
    ...
    %>
  <form action="/frolstore/servlet/AddYqlj" name="f1" method="post">
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          int pages =  0;
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                 ...
                 {
                  %>
                 <a href="/frolstore/admin/spgl.jsp?tj=1&tjid=<%=t.get("id") %>">推荐</a>
                 <%
                 }
                  %>
                 ...
                 {
                  %>
                 <a href="/frolstore/admin/spgl.jsp?tj=0&tjid=<%=t.get("id") %>"><font color="red">取消</font></a>
                 <%
                 }
                  %>
                 ...
                 <td width="60" align="center" valign="middle" class="main_matter_td"><a href="/frolstore/admin/upyqlj.jsp?did=<%=t.get("id") %>">删除</a></td>
               </tr>
              <%
              }
               %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <script language=javascript>
                 function update(id) 
                 {
                  ...
                  pop.setContent("contentUrl","/frolstore/admin/upsp.jsp?id="+id);
                  pop.setContent("title","修改商品信息");
                  pop.build();
                  pop.show();
                 }
               </script>
