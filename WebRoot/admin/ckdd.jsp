  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
          <tr align="center"> 
            ...
            <td width="" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">操作</td>
            <td width="" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">删除</td>
            </tr>
...
String tgrs = dao.select("select* from pros where id='"+proid+"'").get(0).get("tgrs").toString(); 
 %>
          ...
          <td width="" align="center"bgcolor="#FFFFFF"  valign="middle" class="main_matter_td"><a href="/frolstore/admin/ckdd.jsp?upid=<%=h.get("id") %>&state=1&price=<%=h.get("price") %>&num=<%=h.get("num") %>&uid=<%=h.get("uid") %>&proid=<%=h.get("proid") %>">接受并发货</a>&nbsp;|&nbsp;<a href="/frolstore/admin/ckdd.jsp?upid=<%=h.get("id") %>&state=2">拒绝</a></td>
                 <td width="" align="center" valign="middle" bgcolor="#FFFFFF"  class="main_matter_td"><a href="/frolstore/admin/ckdd.jsp?did=<%=h.get("id") %>">删除</a></td>
          </tr>
 <%
 }
  %>          
