...
for(HashMap h:nlist)
{
 %>
          ...
          <td height="26" align="center" bgcolor="#FFFFFF" class=""><a href="/frolstore/admin/upmember.jsp?id=<%=h.get("id") %>">修改</a>      </td>    
          <td height="26" align="center" bgcolor="#FFFFFF" class="">
          <a href="/frolstore/admin/glgl.jsp?did=<%=h.get("id") %>"> 删除</a>            </td>
          </tr>
 <%
 }
  %>          
