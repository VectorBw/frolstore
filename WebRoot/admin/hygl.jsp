 ...
 <%
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
      ...
      <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
          <tr align="center"> 
            <td width="29%" height="18" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">用户名</td>
            <td width="25%" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">密码</td>
            <td width="24%" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">姓名</td>
            <td width="7%" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">性别</td>
            <td width="6%" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">修改</td>
            <td width="9%" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">删除</td>
          </tr>
...
for(HashMap h:list)
{
 %>
          ...
          <a href="/frolstore/admin/hygl.jsp?did=<%=h.get("id") %>"> 删除</a>            </td>
          </tr>
 <%
 }
  %>          
...
共 <%=records %> 条记录
                                ...
                                <a href="/frolstore/admin/hygl.jsp?">首页</a>
                                
                                &nbsp;&nbsp;
                                
                                <a href="/frolstore/admin/hygl.jsp?dpagee=<%=dpage-1 %>">上页</a>
                                
                                &nbsp;&nbsp;
                                
                                <a href="/frolstore/admin/hygl.jsp?dpagee=<%=dpage+1 %>">下页</a>
                                
                                &nbsp;&nbsp;
                                
                                
                                <a href="/frolstore/admin/hygl.jsp?dpagee=<%=pages %>">末页</a>
