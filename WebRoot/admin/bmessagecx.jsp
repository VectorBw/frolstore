...
<input type=submit class='' value='查询信息' /> </td>
      ...
      <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
          <tr align="center"> 
            <td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">留言人</td>
<td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">内容</td>
<td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">回复</td>
<td width="" height="22" background="/frolstore/admin/images/tab_14.gif" class="STYLE1">留言时间</td>
