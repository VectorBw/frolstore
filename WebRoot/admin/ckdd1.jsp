...
if(suc!=null)
{
 ...
 <%
  ...
  <form action="/frolstore/admin/hygl.jsp" name="f1" method="post">
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            cellspacing="0" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                    ...
                    <td width="323" align="center" class="main_title_td_center2">商品名</td>
                    <td width="105" align="center" class="main_title_td_center2">单价</td>
                    <td width="86" align="center" class="main_title_td_center2">数量</td>
                    <td width="230" align="center" class="main_title_td_center2">商品图片</td>
              ...
              List<HashMap> list = dao.select(sql);
               ...
               <tr id="<%=i %>" style="display:<%=style %>"  >
                 ...
                 <td width="230" align="center" valign="middle" class="main_matter_td"><img src="/frolstore/upfile/<%=t.get("img")  %>" height="60" /></td>
                 <td width="174" align="center" valign="middle" class="main_matter_td"><%=t.get("stime") %></td>
                 <td width="261" align="center" valign="middle" class="main_matter_td"><a href="/frolstore/admin/ckdd.jsp?upid=<%=t.get("did") %>&state=1&price=<%=t.get("price") %>&num=<%=t.get("num") %>&uid=<%=t.get("uid") %>">接受并发货</a>&nbsp;|&nbsp;<a href="/frolstore/admin/ckdd.jsp?upid=<%=t.get("did") %>&state=2">拒绝</a></td>
                 <td width="90" align="center" valign="middle" class="main_matter_td"><a href="/frolstore/admin/ckdd.jsp?did=<%=t.get("did") %>">删除</a></td>
               </tr>
              <%
              }
               %>
                ...
                <script language=javascript>
                 function update(no) 
                 {
                  ...
                  pop.setContent("contentUrl","/frolstore/admin/upmember.jsp?id="+no);
...
<script language=javascript src="/frolstore/admin/images/fy.js"></script>
