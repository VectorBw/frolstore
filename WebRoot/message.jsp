...
共 <%=records %> 条记录
                                ...
                                <a href="/frolstore/message.jsp">首页</a>
                                
                                &nbsp;&nbsp;
                                
                                <a href="/frolstore/message.jsp?dpagee=<%=dpage-1 %>">上页</a>
                                
                                &nbsp;&nbsp;
                                
                                <a href="/frolstore/message.jsp?dpagee=<%=dpage+1 %>">下页</a>
                                
                                &nbsp;&nbsp;
                                
                                
                                <a href="/frolstore/message.jsp?dpagee=<%=pages %>">末页</a>
