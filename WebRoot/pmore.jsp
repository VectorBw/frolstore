              ...
              <TR>
                <TD background=shop/02top(1).gif height=27>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD class=titleorange14 align=left width=244>商品列表<br></TD>
                          ...
                          <TR>
                            <TD class=menutitle1>
                              ...
                              align=center border=0>
                                ...
                                <TBODY>
                                <TR>
                                <TD width="38%" rowspan="3" class=menutitle1><img src="/frolstore/upfile/<%=h.get("img") %>" width="70" height="60" /></TD>
                                <TD width="62%" class=menutitle1><a class=orange 
                                href="/frolstore/bookxiang.jsp?id=<%=h.get("id") %>" 
                                ...
                                <a href="/frolstore/pmore.jsp?ptype=<%=ptype %>&key=<%=key %>">首页</a>
                                
                                &nbsp;&nbsp;
                                
                                <a href="/frolstore/pmore.jsp?ptype=<%=ptype %>&key=<%=key %>&dpagee=<%=dpage-1 %>">上页</a>
                                
                                &nbsp;&nbsp;
                                
                                <a href="/frolstore/pmore.jsp?ptype=<%=ptype %>&key=<%=key %>&dpagee=<%=dpage+1 %>">下页</a>
                                
                                &nbsp;&nbsp;
                                
                                
                                <a href="/frolstore/pmore.jsp?ptype=<%=ptype %>&key=<%=key %>&dpagee=<%=pages %>">末页</a>
