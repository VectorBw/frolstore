              ...
              <TR>
                <TD>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD width=529><span class="STYLE4" style="color:#CC6633">商品详情</span></TD>
			...
			%>
				...
				<td width="76%">	  
                  ...
                  pop.show();
							   ...
							   // fcar.action='/frolstore/servlet/Bookcar?bookid='+no; 
							  //  fcar.submit();
							  //  alert("已放入购物车");
							    }
                              </script>                              </td>
             ...
             <tr>
               ...
               <tr>
                ...
                {
                 %>  
                  评级 : <a href="/frolstore/frolstore?ac=pinj&proid=<%=id %>&pj=5">☆☆☆☆☆</a> &nbsp;&nbsp;&nbsp;
